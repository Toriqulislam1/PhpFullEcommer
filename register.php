                     ...
                     <form class="mx-1 mx-md-4">
                       ...
                       <div class="d-flex flex-row align-items-center mb-4">
                         ...
                         <div class="form-outline flex-fill mb-0">
                           ...
                           <input type="text" id="form3Example1c" class="form-control" name="name" value="<?= (isset($_SESSION['nam_val']))? $_SESSION['nam_val']:'' ?>">
                           <?php
                       ...
                       <div class="d-flex flex-row align-items-center mb-4">
                         ...
                         <div class="form-outline flex-fill mb-0">
                           ...
                           <input type="email" id="form3Example3c" class="form-control" name="email" value="<?= (isset($_SESSION['eml_val']))?$_SESSION['eml_val'] :''?>">
